...
import { cursorClasses, primaryClasses } from "./primitives";
import { MapleMark } from "./Brand";
import { useCollaborationSequence } from "./motion/CollaborationSequence";
...
export function CollaborationDemo() {
  ...
  useCollaborationSequence(ref, { run, automatic, setStep });
  useEffect(() => {
      ...
      >
        ...
        >
          ...
          >
            ...
            <p>
              ...
              <br />
              <span className={cn("relative isolate")}>
                <span
                  aria-hidden="true"
                  className="demo-highlight absolute -z-1 inset-0 bg-[#f1d56c69] origin-left"
                />
              ...
              <p className="relative max-w-[calc(100%_-_165px)] wrap-anywhere max-[768px]:max-w-[none]">
                {draft === initialDraft ? (
                  <>
                    ...
                    <span
                      className={cn("demo-phrase inline-block align-bottom")}
                    >
                      create — together.
                    </span>
                  </>
        ...
        <aside
          className={cn(
            ...
            "demo-comment shadow-[0_6px_26px_#1a202014] text-[13px] text-(--muted-ink)",
