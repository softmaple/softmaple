/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: f73d46a734ae41973cafe3370d583bea)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
  COLLAB_ALLOWED_ORIGINS: string;
  SUPABASE_PUBLISHABLE_KEY: string;
  SUPABASE_SERVICE_ROLE_KEY: string;
  SUPABASE_URL: string;
  DOCUMENT_ROOMS: DurableObjectNamespace<import("./src/index").DocumentRoomDO>;
  PRESENCE_ROOMS: DurableObjectNamespace<import("./src/index").PresenceRoomDO>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "DocumentRoomDO" | "PresenceRoomDO";
  }
