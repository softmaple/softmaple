  ...
  return (
    <ContentEditable
      ...
      placeholder={
        <div
          className={cn(
            "text-muted-foreground overflow-hidden absolute overflow-ellipsis top-2 left-11.5 right-7 select-none whitespace-nowrap inline-block pointer-events-none",
