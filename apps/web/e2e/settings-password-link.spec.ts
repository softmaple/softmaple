...
test.describe("Settings Change Password Link", () => {
  test.skip("should navigate to reset password page when clicking Change Password", async ({
    page,
  }) => {
  ...
  test("should render Change Password button in security section", async ({
    page,
  }) => {
